...
CREATE TABLE `course_bases` (
  ...
  CONSTRAINT `course_bases_unit_id` FOREIGN KEY (`unit_id`) REFERENCES `units` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `his_build_courses`
--

DROP TABLE IF EXISTS `his_build_courses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `his_build_courses` (
  `unit_id` int(10) unsigned NOT NULL,
  `course_id` int(10) unsigned NOT NULL,
  `create_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  KEY `his_build_course_unit_id_idx` (`unit_id`),
  KEY `his_build_course_course_id_idx` (`course_id`),
  CONSTRAINT `his_build_course_course_id` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `his_build_course_unit_id` FOREIGN KEY (`unit_id`) REFERENCES `units` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `his_build_courses`
--

LOCK TABLES `his_build_courses` WRITE;
/*!40000 ALTER TABLE `his_build_courses` DISABLE KEYS */;
/*!40000 ALTER TABLE `his_build_courses` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `his_teach_courses`
--

DROP TABLE IF EXISTS `his_teach_courses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `his_teach_courses` (
  `professor_id` int(10) unsigned NOT NULL,
  `course_id` int(10) unsigned NOT NULL,
  `create_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  KEY `his_teach_course_course_id_idx` (`course_id`),
  KEY `his_teach_course_professor_id_idx` (`professor_id`),
  CONSTRAINT `his_teach_course_course_id` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `his_teach_course_professor_id` FOREIGN KEY (`professor_id`) REFERENCES `professor` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `his_teach_courses`
--

LOCK TABLES `his_teach_courses` WRITE;
/*!40000 ALTER TABLE `his_teach_courses` DISABLE KEYS */;
/*!40000 ALTER TABLE `his_teach_courses` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-03-01 15:48:04
